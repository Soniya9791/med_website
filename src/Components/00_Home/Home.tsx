...
const Home: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Virtual consultations for accessible and convenient healthcare from anywhere.",
    },
    {
      icon: icon2,
      title: "Emergency & Urgent Care ",
      description:
        "Get immediate medical attention for urgent health concerns, emergencies, and critical medical situations. ",
    },
  ];
